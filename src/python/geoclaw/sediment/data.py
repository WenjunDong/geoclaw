...
class SedimentData(clawdata.ClawData):
    ...
    def __init__(self):
        ...
        self.add_attribute('toler_for_sediment_flux_limitor',0.01)
        self.add_attribute('Slope_affect_factor',1.6)
    ...
    def write(self,out_file='./sediment.data',data_source='setrun.py'):
        ...
        self.data_write('Slope_affect_factor')
        #processes control paramter
